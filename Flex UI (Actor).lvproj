...
<Project Type="Project" LVVersion="14008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="_Parent Actor Template.lvlib" Type="Library" URL="/&lt;vilib&gt;/East West Architects/Parent Actor Template/_Parent Actor Template.lvlib"/>
		<Item Name="Actor Framework.lvlib" Type="Library" URL="/&lt;vilib&gt;/ActorFramework/Actor Framework.lvlib"/>
		<Item Name="Flex UI (Parent Actor).lvlib" Type="Library" URL="../Flex UI (Actor)/Flex UI (Parent Actor).lvlib"/>
		<Item Name="Flex UI Dialog (Actor).lvlib" Type="Library" URL="../Flex UI Dialog (Actor)/Flex UI Dialog (Actor).lvlib"/>
		<Item Name="Flex UI Subpanel (Actor).lvlib" Type="Library" URL="../Flex UI Subpanel (Actor)/Flex UI Subpanel (Actor).lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Error Dialog.vi" Type="VI" URL="/&lt;vilib&gt;/East West Architects/Parent Actor Template/Error Dialog.vi"/>
				...
				<Item Name="Flex UI Dialog.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/East West Architects/Flex UI/Flex UI Dialog/Flex UI Dialog.lvclass"/>
				<Item Name="Flex UI Subpanel.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/East West Architects/Flex UI/Flex UI Subpanel/Flex UI Subpanel.lvclass"/>
				<Item Name="Flex UI.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/East West Architects/Flex UI/Flex UI (Parent)/Flex UI.lvclass"/>
				...
				<Item Name="MVC Subscription.lvlib" Type="Library" URL="/&lt;vilib&gt;/East West Architects/MVC Subscription/MVC Subscription.lvlib"/>
